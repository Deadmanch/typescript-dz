...
function generateWords(number, words) {
    ...
    if (number < 20) {
        ...
        word = generateWords(Math.floor(number / Numbers.ONE_QUADRILLION)) + ' quadrillion,';
    }
    words.push(word);
    return generateWords(remainder, words);
}
// module.exports = toWords;
console.log(toWords('18', true));
console.log(toWords('133', true));
console.log(toWords('-123'));
console.log(toWords('1000222'));
console.log(toWords('13213455'));
console.log(toWords('-956467354245', true));
